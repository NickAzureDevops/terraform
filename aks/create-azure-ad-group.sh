...
AZURE_AD_GROUP_NAME="kubernetes-example"

# New-AzureADGroup -Description "TsInfoGroupNew group is for TsInfo" -DisplayName "TsInfoGroupNew" -MailEnabled $false -SecurityEnabled $true
...
AZURE_GROUP_ID=$(az ad group show --group "kubernetes-example" --query objectId -o tsv)
